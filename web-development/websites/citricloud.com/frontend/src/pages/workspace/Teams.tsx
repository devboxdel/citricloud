    ...
    <div className="h-screen flex flex-col bg-white dark:bg-gray-900">
      <div className="bg-teal-700 text-white px-3 py-2 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <>
            <img src="/lightmode.svg?v=8" alt="CITRICLOUD Teams" className="h-3 sm:h-4 w-auto hidden" />
            <img src="/darkmode.svg?v=8" alt="CITRICLOUD Teams" className="h-3 sm:h-4 w-auto" />
          </>
